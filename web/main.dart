...
void main(){
  ...
  new Router()
    ...
    ..addHandler(urls.teach, showTeach)//学习训练界面
    ..addHandler(urls.learn, showLearn)//教学训练界面
    ...
    ..addHandler(urls.end, showEnd)//抄报错题界面
...
//route client
void showSign(String path){

}

void showMain(String path){

}
void  showTeach(String path){

}
void showLearn(String path){
...
void showPractice(String path){

}
void showMread(String path){

}
void showSread(String path){

}
void showMeread(String path){

}
void showMwrite(String path){

}
void showSwrite(String path){

}
void showMewrite(String path){

}
void showMerror(String path){

}
void showRerror(String path){

}
void showWerror(String path){

}
void showEnd(String path){
