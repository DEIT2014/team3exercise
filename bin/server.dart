...
//w.r
response_w_letter(resquest){
  //todo 访问字母抄报列表，获取字母抄报练习题
}
response_w_figure(resquest){
  //todo 访问数字抄报列表，获取数字抄报练习题
}
response_w_phrase_letter(resquest){
  //todo 访问字母短语抄报列表，获取字母短语抄报练习题
}
response_w_phrase_figure(resquest){
  //todo 访问数字短语抄报列表，获取数字短语抄报练习题
}
response_w_phrase_mixture(resquest){
  //todo 访问混合短语抄报列表，获取混合短语抄报练习题
}
response_w_sentence(resquest){
  //todo 访问长句抄报列表，获取长句抄报练习题
}
response_r_letter(resquest){
  //todo 访问字母读报列表，获取字母读报练习题
}
response_r_figure(resquest){
  //todo 访问数字读报列表，获取数字读报练习题
}
response_r_phrase_letter(resquest){
  //todo 访问字母短语读报列表，获取字母短语读报练习题
}
response_r_phrase_figure(resquest){
  //todo 访问数字短语读报列表，获取数字短语读报练习题
}
response_r_phrase_mixture(resquest){
  //todo 访问混合短语读报列表，获取混合短语抄读练习题
}
response_r_sentence(resquest){
  //todo 访问长句读报列表，获取长句抄读练习题
}
//err
response_err_w_letter(resquest){
  //todo 访问字母抄报错题列表，获取字母抄报错题
}
response_err_w_figure(resquest){
  //todo 访问数字抄报错题列表，获取数字抄报错题
}
response_err_w_phrase_letter(resquest){
  //todo 访问字母短语抄报错题列表，获取字母短语抄报错题
}
response_err_w_phrase_figure(resquest){
  //todo 访问数字短语抄报错题列表，获取数字短语抄报错题
}
response_err_w_phrase_mixture(resquest){
  //todo 访问混合短语抄报错题列表，获取混合短语抄报错题
}
response_err_w_sentence(resquest){
  //todo 访问长句抄报错题列表，获取长句抄报错题
  }
response_err_r_letter(resquest){
  //todo 访问字母读报错题列表，获取字母读报错题
}
response_err_r_figure(resquest){
  //todo 访问数字读报错题列表，获取数字读报练错题
}
response_err_r_phrase_letter(resquest){
  //todo 访问字母短语读报错题列表，获取字母短语读报错题
}
response_err_r_phrase_figure(resquest){
  //todo 访问数字短语读报错题列表，获取数字短语读报错题
}
response_err_r_phrase_mixture(resquest){
  //todo 访问混合短语读报错题列表，获取混合短语抄读错题
}
response_err_r_sentence(resquest){
  //todo 访问长句读报列表，获取长句抄读练习题
}
//post
send_err_w_letter(resquest) {
  //todo 发送字母抄报错题至字母抄报错题列表
}
send_err_w_figure(resquest){
  //todo 发送数字抄报错题至数字抄报错题列表
}
send_err_w_phrase_letter(resquest){
  //todo 发送字母短语抄报错题至字母短语抄报错题列表
}
send_err_w_phrase_figure(resquest){
  //todo 发送数字短语抄报错题至数字短语抄报错题列表
}
send_err_w_phrase_mixture(resquest){
  //todo 发送混合短语抄报错题至混合短语抄报列表题
}
send_err_w_sentence(resquest){
  //todo 发送长句抄报错题至长句抄报列表题
}
send_err_r_letter(resquest){
  //todo 发送字母读报错题至字母读报错题列表
}
send_err_r_figure(resquest){
  //todo 发送数字读报错题至数字读报错题列表
}
send_err_r_phrase_letter(resquest){
  //todo 发送字母短语读报错题至字母短语读报错题列表
}
send_err_r_phrase_figure(resquest){
  //todo 发送数字短语读报错题至数字短语读报错题列表
}
send_err_r_phrase_mixture(resquest){
  //todo 发送混合短语读报错题至混合短语读报错题列表
}
send_err_r_sentence(resquest){
